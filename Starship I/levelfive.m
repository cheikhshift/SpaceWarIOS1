...
-(id)initWithSize:(CGSize)size score: (NSInteger)player_score{
    if (self = [super initWithSize:size]) {
        ...
        SKSpriteNode *sn = [SKSpriteNode spriteNodeWithImageNamed:@"background 4.png"];
        
        sn.position = CGPointMake(CGRectGetMidX(self.frame), CGRectGetMidY(self.frame));
        sn.name = @"BACKGROUND";
        
        [self addChild:sn];
        [self initalizingScrollingBackground:@"Planet 4.png"];
        [self addShip];
        _lastAttack = 0;
        _fileinter = 0;
        _currentRendered = 0;
        ...
        _playerlife = 50;
        _killedoff = 0;
        ennemyfleet = @{ @"k1" : @"planet 4 destroyers.png", @"k2" : @"planet 4 captains.png", @"k3" : @"planet 4 guards.png" };
        ...
        movey = @{ @"k1" : @2, @"k2" : @30, @"k3" : @20 , @"k4": @0 , @"k5": @2 , @"k6": @18, @"k7": @0, @"k8": @6, @"k9": @5, @"k10": @4, @"k11": @4, @"k12": @2, @"k13": @10, @"k14": @1, @"k15": @2, @"k16": @2, @"k17": @10, @"k18": @4, @"k19": @9, @"k20": @10, @"k21": @8, @"k22": @1, @"k23": @4, @"k24": @9, @"k26": @8, @"k25": @5, @"k26": @2, @"k27": @6, @"k28": @9, @"k29": @2, @"k30": @1, @"k31": @4, @"k32": @1, @"k33": @1};
...
-(void)addSpecial:(NSString *) withName
{
    ...
    [self addChild:missile];
    SKAction *align;
    if ([withName isEqualToString:@"planet 4 destroyers.png"]) {
        align = [SKAction moveByX:-100 y:0 duration:1.4];
        _playerScore = _playerScore + 25;
    }
    else if ([withName isEqualToString:@"planet 4 captains.png"]){
        align = [SKAction moveByX:-185 y:0 duration:1.4];
        _playerScore = _playerScore + 15;
    }
    else {
        align = [SKAction moveByX:-240 y:0 duration:1.4];
...
-(void) addboss {
    ...
    if(_killedoff > 15){
        ...
        SKScene * nextlevel = [[levelTransition alloc] initWithSize:self.size score:_playerScore next:5 caption:@"Welcome to a rocky planet"];
...
-(void)update:(CFTimeInterval)currentTime {
    ...
    if (self.paused == NO ) {
        ...
        if( currentTime - _lastMissileAdded > 1)
        {
            ...
            [self addObstacle:@"planet 4 soldiers.png"];
            _playerScore = _playerScore + 1;
            _lastAttack = _lastAttack + 1;
            
            if(_currentRendered < 16){
                if(_lastAttack == 3){
...
- (void)didBeginContact:(SKPhysicsContact *)contact
{
        ...
        (secondBody.categoryBitMask & obstacleCategory) != 0)
    {
        ...
        if(_playerlife > 0){
            ...
            SKTransition *reveal = [SKTransition flipHorizontalWithDuration:0.5];
            SKScene * gameOverScene = [[cosmosPAUSE alloc] initWithSize:self.size score:_playerScore ifreplay:4];
            [self.view presentScene:gameOverScene transition: reveal];
        }
        //NSLog(@"%i", _playerlife);
