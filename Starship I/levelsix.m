...
-(id)initWithSize:(CGSize)size score: (NSInteger)player_score{
    if (self = [super initWithSize:size]) {
        ...
        movey = @{ @"k1" : @2, @"k2" : @3, @"k3" : @2 , @"k4": @0 , @"k5": @1 , @"k6": @8, @"k7": @0, @"k8": @6, @"k9": @5, @"k10": @4, @"k11": @4, @"k12": @7, @"k13": @4, @"k14": @1, @"k15": @2, @"k16": @2, @"k17": @0, @"k18": @4, @"k19": @9, @"k20": @1, @"k21": @8, @"k22": @1, @"k23": @4, @"k24": @3, @"k26": @4, @"k25": @5, @"k26": @2, @"k27": @6, @"k28": @0, @"k29": @2, @"k30": @1, @"k31": @1, @"k32": @1, @"k33": @1};
...
-(void) addboss {
    ...
    if(_killedoff > 14){
        ...
        SKScene * nextlevel = [[levelTransition alloc] initWithSize:self.size score:_playerScore next:6 caption:@"Welcome to a rocky planet"];
...
- (void)didBeginContact:(SKPhysicsContact *)contact
{
        ...
        (secondBody.categoryBitMask & obstacleCategory) != 0)
    {
        ...
        if(_playerlife > 0){
            ...
            SKTransition *reveal = [SKTransition flipHorizontalWithDuration:0.5];
            SKScene * gameOverScene = [[cosmosPAUSE alloc] initWithSize:self.size score:_playerScore ifreplay:5];
            [self.view presentScene:gameOverScene transition: reveal];
        }
        //NSLog(@"%i", _playerlife);
