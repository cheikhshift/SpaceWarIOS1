...
-(id)initWithSize:(CGSize)size score: (NSInteger)player_score{
    if (self = [super initWithSize:size]) {
        ...
        SKSpriteNode *sn = [SKSpriteNode spriteNodeWithImageNamed:@"background 8.png"];
        
        sn.position = CGPointMake(CGRectGetMidX(self.frame), CGRectGetMidY(self.frame));
        sn.name = @"BACKGROUND";
        
        [self addChild:sn];
        [self initalizingScrollingBackground:@"Planet 8.png"];
        [self addShip];
        _lastAttack = 0;
        _fileinter = 0;
        _currentRendered = 0;
        ...
        _playerlife = 50;
        _killedoff = 0;
        ennemyfleet = @{ @"k1" : @"planet 8 destroyers.png", @"k2" : @"planet 8 captains.png", @"k3" : @"planet 8 guards.png" };
        ...
        movey = @{ @"k1" : @2, @"k2" : @4, @"k3" : @6 , @"k4": @8 , @"k5": @10 , @"k6": @12, @"k7": @14, @"k8": @16, @"k9": @5, @"k10": @4, @"k11": @4, @"k12": @12, @"k13": @14, @"k14": @1, @"k15": @2, @"k16": @2, @"k17": @10, @"k18": @4, @"k19": @9, @"k20": @10, @"k21": @8, @"k22": @1, @"k23": @4, @"k24": @9, @"k26": @26, @"k25": @5, @"k26": @2, @"k27": @6, @"k28": @0, @"k29": @8, @"k30": @1, @"k31": @4, @"k32": @2, @"k33": @6};
...
-(void)addSpecial:(NSString *) withName
{
    ...
    [self addChild:missile];
    SKAction *align;
    if ([withName isEqualToString:@"planet 8 destroyers.png"]) {
        align = [SKAction moveByX:-150 y:0 duration:1.4];
        _playerScore = _playerScore + 25;
    }
    else if ([withName isEqualToString:@"planet 8 captains.png"]){
...
-(void) addboss {
    ...
    if(_killedoff < 14){
        ...
        SKScene * nextlevel = [[levelTransition alloc] initWithSize:self.size score:_playerScore next:9 caption:@"Welcome to a rocky planet"];
...
-(void)update:(CFTimeInterval)currentTime {
    ...
    if (self.paused == NO ) {
        ...
        if( currentTime - _lastMissileAdded > 1)
        {
            ...
            [self addObstacle:@"planet 8 soldiers.png"];
...
- (void)didBeginContact:(SKPhysicsContact *)contact
{
        ...
        (secondBody.categoryBitMask & obstacleCategory) != 0)
    {
        ...
        if(_playerlife > 0){
            ...
            SKTransition *reveal = [SKTransition flipHorizontalWithDuration:0.5];
            SKScene * gameOverScene = [[cosmosPAUSE alloc] initWithSize:self.size score:_playerScore ifreplay:8];
            [self.view presentScene:gameOverScene transition: reveal];
        }
        //NSLog(@"%i", _playerlife);
